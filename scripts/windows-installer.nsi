...
!define GROUPNAME "XinFin Network"
!define HELPURL "https://github.com/xinfinorg"
!define UPDATEURL "https://github.com/xinfinorg"
!define ABOUTURL "https://xinfin.org"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\XDCChain"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "XDC incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\XDC\unpacked\XDC.exe" "" "" "Ethereum" 30303 "" "" ""
    #SimpleFC::AdvAddRule "XDC outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\XDC\unpacked\XDC.exe" "" "" "Ethereum" "" 30303 "" ""
    #SimpleFC::AdvAddRule "XDC UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\XDC\unpacked\XDC.exe" "" "" "Ethereum" "" 30303 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "XDC incoming peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "XDC outgoing peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "XDC UDP discovery (UDP:30303)"
